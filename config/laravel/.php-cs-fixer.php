...
// Create finder
// Note: Blade templates (.blade.php) are PHP files with special syntax
// PHP-CS-Fixer can format them, but be careful with Blade directives
$finder = Finder::create()
    ->in($paths)
    ->exclude($exclude)
    ->name('*.php')
    // Include .blade.php files for Laravel Blade templates
    // Note: Some Blade-specific syntax may need manual review after formatting
    ->name('*.blade.php')
    ->ignoreDotFiles(true)
    ->ignoreVCS(true);
