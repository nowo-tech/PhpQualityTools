...
git commit -m "chore(release): prepare 1.0.10"

# 2. Create annotated tag (see BRANCHING.md)
git tag -a v1.0.10 -m "Release v1.0.10 - PHPStan level 8, PHP 8.1+, Symfony 6.0-7.4, Laravel 9-11"
...
- [ ] Create a GitHub Release from tag `v1.0.10`
...
- `Release v1.0.10 - PHPStan level 8, PHP 8.1+, Symfony 6.0-7.4, Laravel 9-11`
